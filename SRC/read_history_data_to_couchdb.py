"""
The ppurpose of this code is to read a json file(stores tweets) to couchDB
We download the tweets in Melbourne from 2012 t0 2016 from the Unimelb Research Cloud
this code will read this to couchDB and will not read duplicate tweet
"""
